...
import com.acme.acmepools.converter.BooleanToCharacterConverter;
...
@Table(name = "CUSTOMER",indexes={
    @Index(columnList="CURRENT_MAINTENANCE")
})
@XmlRootElement
@NamedQueries({
...
public class Customer implements Serializable {
    ...
    private boolean currentMaintenance;
    ...
    public Customer(boolean currentMaintenance){
     ...
     */
    public boolean isCurrentMaintenance() {
     ...
     */
    public void setCurrentMaintenance(boolean currentMaintenance) {
        this.currentMaintenance = currentMaintenance;
    }
